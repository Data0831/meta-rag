...
export const searchIconBtn = document.getElementById('searchIconBtn');
export const llmRewriteCheckbox = document.getElementById('llmRewriteCheckbox');
...
export const errorState = document.getElementById('errorState');
