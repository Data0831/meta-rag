...
# Month format conversion mapping
MONTH_NUM_TO_NAME = {
    "01": "january",
    "02": "february",
    "03": "march",
...
class SearchService:
    ...
    def search(self, user_query: str, limit: int = 20) -> Dict[str, Any]:
        ...
        # Convert months format from YYYY-MM to YYYY-monthname
        ...
        with concurrent.futures.ThreadPoolExecutor() as executor:
            ...
            def qdrant_task():
                ...
                return db_adapter_qdrant.search_semantic(
                    query_vector=embedding, filters=intent.filters, limit=limit
                )
        ...
        return {"intent": intent.model_dump(), "results": ordered_docs}
